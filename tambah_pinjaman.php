                                        ...
                                        <div class="card-body shadow p-3 rounded">
                                            <div class="card">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <div class="md-form mt-0">
                                                            <div class="form-group row">
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control" id="Tgl_Entri" value="<?= $date->format('d F Y, H:i:s A'); ?>" name="Tgl_Entri" required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <div class="md-form mt-0">
                                                            <input type="text" class="form-control text-right" id="Besar_Pinjaman" placeholder="0.00" name="Besar_Pinjaman" required>
                                                            <div class="valid-feedback">Valid.</div>
                                                            <div class="invalid-feedback">Harap isi kolom ini.</div>
                                                        </div>
                                                    </div>
