                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group row">
                                        <label for="Nama_Pinjaman" class="col-sm-4 col-form-label text-right">Nama Panduan :</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group row">
                                        <label for="Max_Pinjaman" class="col-sm-4 col-form-label text-right">Isi Panduan :</label>
                                        <div class="col-sm-8">
                                            <div class="md-form mt-0">
                                                <textarea rows="3" class="form-control text-right" name="Isi_Panduan" required></textarea>
                                                <div class="valid-feedback">Valid.</div>
                                                <div class="invalid-feedback">Harap isi kolom ini.</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="Bunga" class="col-sm-4 col-form-label text-right">Jenis Panduan :</label>
                                        <div class="col-sm-8">
                                            <div class="md-form mt-0">
                                                <input type="text" value="<?= $_GET['Konfigurasi']; ?>" class="form-control text-right" name="Jenis_Panduan" readonly>
                                                <div class="valid-feedback">Valid.</div>
                                                <div class="invalid-feedback">Harap isi kolom ini.</div>
                                            </div>
                                        </div>
